...
description: Review and maintain ~/.codex/rules/default.rules from recent Codex thread evidence. Use when asked to scan recent sessions for repeated approval pain points, add safe narrow prefix_rule entries, dedupe existing rules, or remove stale approval rules.
---
