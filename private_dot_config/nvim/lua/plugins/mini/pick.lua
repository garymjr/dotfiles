require("mini.deps").later(function()
  ...
  vim.keymap.set(
    ...
    "<leader><space>",
    "<cmd>Pick files<cr>",
    { desc = "Find Files (Root Dir)", silent = true }
  )
  vim.keymap.set(
    "n",
    "<leader>fb",
  ...
  vim.keymap.set(
    ...
    "<leader>fF",
    "<cmd>Pick files<cr>",
    { desc = "Find Files (cwd)", silent = true }
  )
  ...
  vim.keymap.set(
    ...
    { desc = "Grep (Root Dir)", silent = true }
  )
  ...
  vim.keymap.set(
    ...
    { desc = "Quickfix List", silent = true }
  )
